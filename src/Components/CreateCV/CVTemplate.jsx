...
function CVTemplate({ data, width }) {
	...
	return (
		<div className=" ">
			<div className="CV_Template-container overflow-auto ps-2">
		<div id="CV_Template" className="row page cv-part-1 m-auto" style={{ width, height: width *1.41 }}>
